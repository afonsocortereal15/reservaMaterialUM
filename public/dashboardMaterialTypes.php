      ...
      <div class="container">
        <div class="row gx-5 align-items-center justify-content-center">
          <div class="col-md-12 bg-white rounded-3" style="padding: 20px;">
            ...
            <form action="dashboardMaterialTypes.php" method="GET">
              <!-- Material type select -->
              <select class="mb-1" id="type" name="type" required>
                <option value="" selected>Selecione tipo de material</option>
                <?php
